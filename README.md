...
6 | [ZigZag Conversion](https://leetcode.com/problems/zigzag-conversion/) | :lock: <br> 1. [Java ](solutions/zigzag_conversion_sortRows.java) | | 
...
21 | [Merge Two Sorted Lists](https://leetcode.com/problems/merge-two-sorted-lists/) | :lock: <br> 1. [Java - Recursive](solutions/merge_two_sorted_lists_recursive.java), <br> 2. [Java - Iterative](solutions/merge_two_sorted_lists_iterative.java)
24 | [Swap Nodes in Pairs](https://leetcode.com/problems/swap-nodes-in-pairs/) | :lock: <br> 1. [Java - Recursive](solutions/swap_nodes_in_pairs_recursive.java), <br> 2. [Java - Iterative](solutions/swap_nodes_in_pairs_iterative.java) | [CS Practice](https://www.youtube.com/watch?v=x2TMb57goAI)
25 | [Reverse Nodes in k-Group](https://leetcode.com/problems/reverse-nodes-in-k-group/) | :lock: <br> 1. [Java - Recursive](solutions/reverse_nodes_in_k_group_recursive.java), <br> 2. [Java - Iterative](solutions/reverse_nodes_in_k_group_iterative.java)
...
31 | [Next Permutation](https://leetcode.com/problems/next-permutation/) | 1. [Java](solutions/next_permutations.java) | [Back to Back SWE](https://www.youtube.com/watch?v=quAS1iydq7U)
33 | [Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/) | :lock: <br> 1. [Java - Two Pass](solutions/search_in_rotated_sorted_array_binray_search_two_pass.java), <br> 2.[Java - One Pass](search_in_rotated_sorted_array_binray_search_one_pass.java)
...
38 | [Count and Say](https://leetcode.com/problems/count-and-say/) | 1. [Java](solutions/count_and_say_1.java), <br> 2. []() | 1. [Terrible Whiteboard](https://www.youtube.com/watch?v=qGMq-Zi8MVg), <br> 2. [Amell](https://www.youtube.com/watch?v=-wB1xj-kOe0) | [LeetCode Discuss](https://leetcode.com/problems/count-and-say/discuss/16040/Straightforward-Java-Solution)
42 | [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) | 1. [Java - Two Pointers](soutions/trapping_rain_water.java) | [NeetCode](https://www.youtube.com/watch?v=ZI2z5pq0TqA)
...
50 | [Pow(x, n)](https://leetcode.com/problems/powx-n/) | :lock: <br> 1. [ Fast Pow Recursive](solutions/pow(x,n)_fastpow_recursive.java) | [ Knowledge Center](https://www.youtube.com/watch?v=snOaKR2xgZg)
...
81 | [Search in Rotated Sorted Array II](https://leetcode.com/problems/search-in-rotated-sorted-array-ii/) | :no_entry_sign: [Java](solutions/search_in_a_rotated_sorted_array_ii.java)
82 | [Remove Duplicates from Sorted List II](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/) | :no_entry_sign: <br> 1. [Java - Iterative](solutions/remove_duplicates_from_sorted_list_ii_iterative.java), <br> 2. [Java - Recursive](solutions/remove_duplicates_from_sorted_list_ii_recursive.java) | | [GeeksforGeeks](https://www.geeksforgeeks.org/remove-occurrences-duplicates-sorted-linked-list/), <br> [LeetCode Discuss](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/discuss/28335/My-accepted-Java-code) - For recursive solution.
83 | [Remove Duplicates from Sorted List](https://leetcode.com/problems/remove-duplicates-from-sorted-list/) | 1. [Java - Iterative](solutions/remove_duplicates_from_sorted_list_iterative.java), <br> 2. [Java - Recursive](solutions/remove_duplicates_from_sorted_list_rescursive.java) | | Follow up - 82, <br> [GeeksforGeeks - Iterative](https://www.geeksforgeeks.org/remove-duplicates-from-a-sorted-linked-list/?ref=rp), <br> [GeeksforGeeks - Recursive](https://www.geeksforgeeks.org/remove-duplicates-sorted-linked-list-using-recursion/?ref=rp)
88 | [Merge Sorted Arrays](https://leetcode.com/problems/merge-sorted-array/) | :lock: <br> 1. [Java - Merge & Sort](solutions/merge_sorted_arrays_merge_and_sort.java), <br> 2. [Java - Two Pointer from start](solutions/merge_sorted_arrays_two_pointer_from_start.java), <br> 3. [Java - Two Pointer from end](solutions/merge_sorted_arrays_two_pointer_from_end.java) | |
...
92 | [Reverse Linked List II](https://leetcode.com/problems/reverse-linked-list-ii/) | 1. [Java - Recursive](soutions/reverse_linked_list_ii_recursive.java), <br> 2. [Java - Iterative](solutions/reverse_linked_list_ii_iterative.java)
100 | [Same Tree](https://leetcode.com/problems/same-tree/) | 1. [Java - Recursion](solutions/same_tree_iterative_recursive.java), <br> 2. [Java - Iterative](solutions/same_tree_iterative.java), <br> 3. [Java - Iterative Optmized](solutions/same_tree_iterative_improved.java)
...
112 | [Path Sum](https://leetcode.com/problems/path-sum/) | [C++](solutions/path_sum.cpp) | |
...
121 | [Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)| 1. [Java - Brute](solutions/best_time_to_buy_and_sell_stocks_brute.java), <br> 2. [Java - One Pass](solutions/best_time_to_buy_and_sell_stocks_one_pass.java) |
122 | [Best Time to Buy and Sell Stock II](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/) | 1. [Java - Peak & Valley](solutions/best_time_to_buy_and_sell_stocks_ii_peak_valley.java), <br> 2. [Java - One Pass](solutions/best_time_to_buy_and_sell_stocks_ii_one_pass.java)
...
143 | [Reorder List](https://leetcode.com/problems/reorder-list/) | :lock: <br> 1. [Java](solutions/reorder_list.java)
146 | [LRU Cache](https://leetcode.com/problems/lru-cache/) | :lock: <br> 1. [Java - Ordered Dicrtionary](solutions/lru_cache_oredered_dictionary.java), <br> 2. [Java - HashMap + DLL](solutions/lrucache_hashmap+dll.java)
148 | [Sort List](https://leetcode.com/problems/sort-list/) | 1. [Java - Merge Sort O(n) space](solutions/sort_list_merge_on.java), <br> 2. [Java - Merge Sort O(1) space](solutions/sort_list_merge_o1.java) | [LeetCode Discuss](https://leetcode.com/problems/sort-list/discuss/46712/Bottom-to-up(not-recurring)-with-o(1)-space-complextity-and-o(nlgn)-time-complextity), <br> [YouTube](https://www.youtube.com/watch?v=WVl2QSe4R14&list=PLRdD1c6QbAqJn0606RlOR6T3yUqFWKwmX)
...
152 | [Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/) | :lock: <br> 1. [Java - Brute](solutions/max_product_subarray_brute.java), <br> 2. [Java - DP](solutions/max_product_subarray_dp.java) | 
...
162 | [Find Peak Element](https://leetcode.com/problems/find-peak-element/) | 1. [Java - Linear Scan](solutions/find_peak_element_linear_scan.java), <br> 2. [Java - Binary Search Recursive](solutions/find_peak_element_binary_search_recursive.java), <br> 3. [Java - Binary Search Iterative](solutions/find_peak_element_binary_search_iterative.java)
...
190 | [Reverse Bits](https://leetcode.com/problems/reverse-bits/) | :lock: <br> [Java](solutions/reverse_bits to reverse_bits.java) | [Nideesh](https://www.youtube.com/watch?v=KE5Axm7uzok) | [LeetCode Discuss](https://leetcode.com/problems/reverse-bits/discuss/54746/Java-Solution-and-Optimization)
...
205 | [Isomorphic Strings](https://leetcode.com/problems/isomorphic-strings/) | :no_entry_sign: <br> 1. [Java](solutions/isomorphic_strings_1.java), 2. [Java](solutions/isomorphic_strings_2.java) | | [LeetCode Discuss](https://leetcode.com/problems/isomorphic-strings/discuss/57810/Short-Java-solution-without-maps), <br> [GeeksforGeeks](https://www.geeksforgeeks.org/check-if-two-given-strings-are-isomorphic-to-each-other/)
206 | [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | 1. [Java - Iterative](solutions/reverse_linked_list_iterative.java), <br> 2. [Java - Recursive](solutions/reverse_linked_list_recursive.java) | [mycodeschool](https://www.youtube.com/watch?v=sYcOK51hl-A) - Iterative, [mycodeschool](https://www.youtube.com/watch?v=KYH83T4q6Vs) - Recursive | Follow up - 92
208 | [Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) | [Java](solutions/implement_trie.java)
214 | [Shortest Palindrome](https://leetcode.com/problems/shortest-palindrome/) | 1. [Java - Brute](solutions/shortest_palindrome_brute.java)
215 | [Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/) | :lock: <br> 1. [Java - Heap](solutions/kth_largest_element_in_an_array_heap.java), <br> 2. [Java - Quick Select](solutions/kth_largest_element_in_an_array_quick.java)
217 | [Contains Duplicate](https://leetcode.com/problems/contains-duplicate/) | 1. [Java - Linear Search](solutions/contains_duplicate_linear_search.java), <br> 2. [Java - Sorting](solutions/contains_duplicate_sorting.java), <br> 3. [Java - HashSet](solutions/contains_duplicate_hashset.java) | | Follow up - 218
218 | [Contains Duplicate II](https://leetcode.com/problems/contains-duplicate-ii/) | :lock: <br> 1. [Java - Linear Search](solutions/contains_duplicate_ii_linear_search.java), <br> 2. [Java - BST](solutions/contains_duplicate_ii_bst.java), <br> 3. [Java - HashSet](solutions/contains_duplicate_ii_hashset.java) | 
221 | [Maximal Square](https://leetcode.com/problems/maximal-square/) | 1. [Java - DP](solutions/maximal_square_dp.java) | [YouTube](https://www.youtube.com/watch?v=RElcqtFYTm0)
...
231 | [Power of Two](https://leetcode.com/problems/power-of-two/) | :lock: <br> [1. Java - Loop](solutions/power_of_two_loop.java), <br> 2. [Java - Bitwise](solutions/power_of_two_bitwise.java), <br> 3. [Java - Bit Manipulation](solutions/power_of_two_bit_manipulation_basic.java) , <br> 4. [Java - Bit Manipulation 1](power_of_two_bit_manipulation_basic1.java.java) | [Amell Peralta](https://www.youtube.com/watch?v=bxnl5ml1G3M)
...
238 | [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) | 1. [Java - Left & Right List](solutions/product_of_array_except_self_left_right_list.java), <br> 2. [Java - Left List Only](solutions/product_of_array_except_self_left_list.java)
...
268 | [Missing Number](https://leetcode.com/problems/missing-number/) | 1. [Java - Sorting](solutions/missing_number_sorting.java), <br> 2. [Java - HashSet](solutions/missing_number_hashset.java), <br> 3. Java - Bit Manipulation, <br> 4. [Java - Gauss Formula](solutions/missing_number_gauss.java)
277 | :lock: <br> [Find the Celebrity](https://github.com/rahulbarhate/LeetCode/blob/master/LeetCode%20Premium%20Questions/Find%20The%20Celebrity.md) | 1. [Java - Brute]()
278 | [First Bad Version](https://leetcode.com/problems/first-bad-version/) | [Java](solutions/first_bad_version_binary_search.java)
...
287 | [Find the Duplicate Number](https://leetcode.com/problems/find-the-duplicate-number/) | 1. [Java - Sorting](solutions/find_the_duplicate_number_sorting.java), <br> 2. [Java - HashSet](solutions/find_the_duplicate_number_hashset.java), <br> 3. [Java - Floyd Cycle Detection](solutions/find_the_duplicate_number_two_pointer.java) | |
326 | [Power of Three](https://leetcode.com/problems/power-of-three/) | 1. [Java - Loop Iteration](solutions/power_of_three_loop_iteration.java), <br> 2. [Java - Base Conversion](solutions/power_of_three_base_conversion.java), <br> 3. [Java - Mathematics](power_of_three_maths.java), <br> 4. [Java - Integer Limitations](power_of_three_integer_limitations.java)
328 | [Odd Even Linked List](https://leetcode.com/problems/odd-even-linked-list/) | [Java](solutions/odd_even_linked_list.java)
...
346 | :lock: <br> [Moving Average from Data Stream](https://github.com/rahulbarhate/LeetCode/blob/master/LeetCode%20Premium%20Questions/Intersection%20of%20Three%20Sorted%20Arrays.md) | 1. [Java - Array/List](solutions/), <br> 2. [Java - Double - Ended Queue](solutions/), <br> 3. [Java - Circular Queue](solutions/)
347 | [Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/) | 1. [Java - Min Heap](solutions/top_k_frequent_elements_min_heap.java), 2. []() | [Code With Mike](https://www.youtube.com/watch?v=vISxv-19N2U)
...
383 | [Ransom Note](https://leetcode.com/problems/ransom-note/) | :lock: <br> 1. [Java - Simulation](solutions/ransom_note_simulation.java), <br> 2. [Java - Two HashMaps](solutions/ransom_note_two_hashmaps.java), <br> 3. [Java - HashMap](solutions/ransom_note_hashmap.java), <br> 4. [Java - Stack](solutions/ransom_note_stack.java) 
387 | [First Unique Character in a String](https://leetcode.com/problems/first-unique-character-in-a-string/) | 1. [Java - HashMap](solutions/first_unique_character_in_a_string_hashmap.java)
...
461 | [Hamming Distance](https://leetcode.com/problems/hamming-distance/) | :lock: <br> 1. [Java - Built-in Functions](solutions/hamming_distance_builtin.java), <br> 2. [Java - Bit Shift](solutions/hamming_distance_bit_shift.java), <br> 3. [Java - Brian Kernighan's](solutions/hamming_distance_brian_kernighan.java)
476 | [Number Complement](https://leetcode.com/problems/number-complement/) | :lock: <br> 1. [Java - Flip Bits ](solutions/number_complement_flip_bit.java), <br> 2. [Java - Bit Length + Bit Mask](solutions/number_complement_bit_length_bitmask.java), <br> 3. [Java - OpenJDK](solutions/number_complement_openJDK.java) | [Kevin](https://www.youtube.com/watch?v=oURSuMY4zSc&list=PLi9RQVmJD2fbO1vqQO7SToUIxzZi-Gb8m) | [Explaination](https://leetcode.com/problems/number-complement/discuss/158120/DETAILED-EXPLANATION-Java-XOR-Method-Easy-To-Understand), [Explaination](https://leetcode.com/problems/number-complement/discuss/175469/Easy-Java-solution-with-comments-to-explain-the-thought-process) | Follow up / Similar Question - 1009
...
498 | [Diagonal Traverse](https://leetcode.com/problems/diagonal-traverse/) | 1. [Java - Simple Simulation](solutions/diagonal_traverse.java) | | [LeetCode Discuss](https://leetcode.com/problems/diagonal-traverse/discuss/581868/Easy-Python-NO-DIRECTION-CHECKING)
...
516 | [Longest Palindromic Subsequence](https://leetcode.com/problems/longest-palindromic-subsequence/) | [Java - DP Top Down](solutions/longest_palindromic_subsequence_dp.java) | [Tushar](https://www.youtube.com/watch?v=_nCsPn7_OgI), [IDeserve](https://www.youtube.com/watch?v=U4yPae3GEO0) | [GeeksforGeeks](https://www.geeksforgeeks.org/longest-palindromic-subsequence-dp-12/)
535 | [Encode and Decode TinyURL](https://leetcode.com/problems/encode-and-decode-tinyurl/) | :lock: <br> 1. [Java - Counter](solutions/encode_and_decode_tinyurl_simple_counter.java), <br> 2. [Java - Variable Length Encoding](solutions/encode_and_decode_tinyurl_simple_variable_length_encoding.java), <br> 3. [](), <br> 4. []()
540 | [Single Element in a Sorted Array](https://leetcode.com/problems/single-element-in-a-sorted-array/) | :lock: <br> 1. [Java - Brute](solutions/single_element_in_a_sorted_array_brute.java), <br> 2. [Java - Binary Search](solutions/single_element_in_a_sorted_array_binar_search.java), <br> 3. [Java - Binary Search on even indices](solutions/single_element_in_a_sorted_array_binar_search_even_indices.java)
543 | [Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/) | 1. [Java- Recursive](solutions/diameter_of_binary_tree.java), <br> 2. [Java - Iterative](solutions/diameter_of_binary_tree_iterative.java)| | [Discuss](https://leetcode.com/problems/diameter-of-binary-tree/discuss/101132/Java-Solution-MaxDepth), [Iterative](https://leetcode.com/problems/diameter-of-binary-tree/discuss/240383/Java-Solutions), 
...
581 | [Shortest Unsorted Continuous Subarray](https://leetcode.com/problems/shortest-unsorted-continuous-subarray/) | 1. [Java - Brute](), <br> 2. [Java - Better Brute](solutions/shortest_unsorted_continuous_subarray_better_brute.java), <br> 3. [Java - Sorting](solutions/shortest_unsorted_continuous_subarray_sorting.java), <br> 4. [Java - Stack](solutions/shortest_unsorted_continuous_subarray_stack.java), <br> 5. [Java - O(1) Space](solutions/shortest_unsorted_continuous_subarray_no_extra_space.java)
617 | [Merge Two Binary Trees](https://leetcode.com/problems/merge-two-binary-trees/) | 1. [Java - Recursive](solutions/merge_two_binary_trees_recursive.java), <br> 2. [Java - DFS Iterative](solutions/merge_two_binary_trees_dfs.java), <br> 3. [Java - BFS Iterative](solutions/merge_two_binary_trees_bfs.java) | | [BFS - Iterative with two queues](https://leetcode.com/problems/merge-two-binary-trees/discuss/282694/Java-BFS-using-Queues-Solution-or-Easy-to-Read), [BFS - Iterative with two queues](https://leetcode.com/problems/merge-two-binary-trees/discuss/436821/BFS-souliution), [DFS & BFS single Data Structure](https://leetcode.com/problems/merge-two-binary-trees/discuss/104331/Java-One-Recursive-Solution-and-Two-Iterative-Solutions-(DFS-and-BFS)-with-Explanations)
633 | [Sum of Square Numbers](https://leetcode.com/problems/sum-of-square-numbers/) | 1. [Java - Brute](solutions/sum_of_square_numbers_brute.java), <br> 2. [Java - Better Brute](solutions/sum_of_square_numbers_better_brute.java), <br> 3. [Java - sqrt()](solutions/sum_of_square_numbers_sqrt_function.java), <br> 4. [Java - Binary search](solutions/sum_of_square_numbers_binary_search.java), <br> 5. Fermat Theorem
...
701 | [Insert into a Binary Search Tree](https://leetcode.com/problems/insert-into-a-binary-search-tree/) | :lock: <br> 1. [Java - Recursive](solutions/insert_into_a_binary_search_tree_recursive.java), <br> 2. [Java -Iterative](solutions/insert_into_a_binary_search_tree_iterative.java) |
704 | [Binary Search](https://leetcode.com/problems/binary-search/) | [Java](solutions/binary_search.java)
709 | [To Lower Case](https://leetcode.com/problems/to-lower-case/) | :lock: <br> 1. [Java - Built-in Function](solutions/to_lower_case_builtin.java), <br> 2. [Java - HashMap](solutions/to_lower_case_hashmap.java), <br> 3. [Java - Function Implementation](solutions/to_lower_case_function_implementation.java), <br> | | [to Upper Case](solutions/o_upper_case.java)
725 | [Split Linked List in Parts](https://leetcode.com/problems/split-linked-list-in-parts/) | 1. [Java - Create new list](solutions/split_linked_list_in_parts.java), <br> 2. [Java - Split input list](solutions/split_linked_list_in_parts_split_input_list.java) 
733 | [Flood Fill](https://leetcode.com/problems/flood-fill/) | 1. [Java - DFS](solutions/flood_fill_dfs.java), <br> 2. [Java - BFS](solutions/flood_fill_bfs.java) | [Kevin](https://www.youtube.com/watch?v=TClRuEZ-uDg&list=PLi9RQVmJD2fY_-QarOPWzUepqEkHda2UY), [Nick](https://www.youtube.com/watch?v=aehEcTEPtCs) - DFS, <br> [Amell](https://www.youtube.com/watch?v=4yZwczAHRto) - BFS | DFS, BFS
747 | [Largest Number At Least Twice of Others](https://leetcode.com/problems/largest-number-at-least-twice-of-others/) | 1. [Java](solutions/largest_number_at_least_twice_of_others.java) | 2. [Java - Optimized](solutions/largest_number_at_least_twice_of_others_optimized.java)
766 | [Toeplitz Matrix](https://leetcode.com/problems/toeplitz-matrix/) | 1. [Java](solutions/toeplitz_matrix_groups.java), <br> 2. [Java](solutions/toeplitz_matrix_compareWithNeighbors.java) | [WorkWithGoogler](https://www.youtube.com/watch?v=QsbSfTyMqg8), <br> [Amell](https://www.youtube.com/watch?v=eIj_Dib1S0A)
771 | [Jewels and Stones](https://leetcode.com/problems/jewels-and-stones/) | :lock: <br> 1. [Java - Brute](solutions/jewels_and_stones_brute.java), <br> 2. [Java - Hashset](solutions/jewels_and_stones_hashset.java)
796 | [Rotate String](https://leetcode.com/problems/rotate-string/) | 1. [Java - Brute](solutions/rotate_string_brute.java), <br> 2. [Java - Simple Check](solutions/rotate_string_simple_check.java), <br> 3. Java - Rolling Hash(), <br> 4.Java - KNP() | | [continue - java](https://www.w3schools.com/java/showjava.asp?filename=demo_continue)
804 | [Unique Morse Code Words](https://leetcode.com/problems/unique-morse-code-words/) | [Java](solutions/unique_morse_code_words.java)
817 | [Linked List Components](https://leetcode.com/problems/linked-list-components/) | [Java](solutions/linked_list_components.java) | [LeetCode Discuss](https://leetcode.com/problems/linked-list-components/discuss/123842/C%2B%2BJavaPython-Easy-and-Concise-Solution-with-Explanation)
...
821 | [Shortest Distance to a Character](https://leetcode.com/problems/shortest-distance-to-a-character/) | 1. [Java](solutions/shortest_distance_to_character.java), <br> 2. [Java - Nick](solutions/shortest_distance_to_character_nick.java) | [Nick](https://www.youtube.com/watch?v=YMKpDBmDJQE)
844 | [Backspace String Compare](https://leetcode.com/problems/backspace-string-compare/) | 1. C++
867 | [Transpose Matrix](https://leetcode.com/problems/transpose-matrix/) | 1. [Java - additional array](solutions/transpose_matrix.java), <br> 2. [Java - in place](solutions/transpose_matrix_in_place.java)
...
896 | [Monotonic Array](https://leetcode.com/problems/monotonic-array/) | 1. [Java - Two pass](solutions/monotonic_array_two_pass.java), <br> 2. [Java - One Pass](solutions/monotonic_array_one_pass.java), <br> 3. [Java - One Pass Simplified](solutions/monotonic_array_one_pass_simplified.java)
898 | [Bitwise ORs of Subarrays](https://leetcode.com/problems/bitwise-ors-of-subarrays/) | 1. [Java - Frotier Set](solutions/bitwise_or_of_subarrays.java)
905 | [Sort Array By Parity](https://leetcode.com/problems/sort-array-by-parity/) | 1. [Java - Comparators](solutions/sort_array_by_parity_sort.java), <br> 2. [Java - Two Pass](solutions/sort_array_by_parity_two_pass.java), <br> 3. [Java - One Pass](solutions/sort_array_by_parity_one_pass.java) | | Follow - up - 922
922 | [Sort Array By Parity II](https://leetcode.com/problems/sort-array-by-parity-ii/) | 1. [Java - Brute](solutions/sort_array_by_parity_ii_brute.java), <br> 2. [Java - In-place](solutions/sort_array_by_parity_ii_in_place.java)
938 | [Range Sum of BST](https://leetcode.com/problems/range-sum-of-bst/) | 1. [Java - Iterative](solutions/range_sum_of_bst_iterative.java), <br> 2. [Java - recursive](solutions/range_sum_of_bst_recursive.java)  | [Kevin](https://www.youtube.com/watch?v=SIdrJwWp3H0) - Iterative, <br> [Nick](https://www.youtube.com/watch?v=Re0QTM4hBuI) - Both
...
973 | [K Closest Points to Origin](https://leetcode.com/problems/k-closest-points-to-origin/) | 1. [Java - Sort](solutions/k_closest_points_to_origin_sort.java), <br> 2. [Java - Divide and Conquer](solutions/k_closest_points_to_origin_divide_and_conquer.java), <br> 3. [Java - Max Heap](solutions/k_closest_points_to_origin_max_heap.java) | [Nick](https://www.youtube.com/watch?v=1rEUgAG7f_c) | [LeetCode Discuss](https://leetcode.com/problems/k-closest-points-to-origin/discuss/220235/Java-Three-solutions-to-this-classical-K-th-problem.)
976 | [Largest Perimeter Triangle](https://leetcode.com/problems/largest-perimeter-triangle/) | [Java](solutions/largest_perimeter_triangle.java)
977 | [Squares of a Sorted Array](https://leetcode.com/problems/squares-of-a-sorted-array/) | 1. [Java - Sort](solutions/squares_of_a_sorted_array_sort.java), <br> 2. [Java - Two Pointers](solutions/squares_of_a_sorted_array_two_pointer.java), <br> 3. [Java - One Pass](solutions/squares_of_a_sorted_array_one_pass.java) | [Nick](https://www.youtube.com/watch?v=PN68qx-Qkdw)
993 | [Cousins in Binary Tree](https://leetcode.com/problems/cousins-in-binary-tree/) | :lock: <br> 1. [Java - DFS Recursive](solutions/cousins_in_binary_tree_dfs_recursive.java), <br> 2. []()
994 | [Rotten Oranges](https://leetcode.com/problems/rotting-oranges/) | :lock: <br> 1. [Java - Kevin](solutions/rotten_oranges_kevin.java), <br> 2. [Java - BFS](solutions/rotten_oranges_bfs.java), <br> 3. [Java - In Place BFS](solutions/rotten_oranges_bfs_in_place.java)
997 | [Find the Town Judge](https://leetcode.com/problems/find-the-town-judge/) | :lock: <br> 1. [Java - Two Arrays](solutions/find_the_town_judge_two_arrays.java), <br> 2. [Java - One Array](solutions/find_the_town_judge_one_array.java)
1009 | [Complement of Base 10 Integer](https://leetcode.com/problems/complement-of-base-10-integer/) | :lock: <br> 1. [Java - Flip Bits](solutions/complement_of_base_10_integer_flip_bits.java), <br> 2. [Java - Bit Length + Bit Mask](solutions/complement_of_base_10_integer_bit_length_bitmask.java), <br> 3. [Java - OpenJDK](solutions/complement_of_base_10_integer_openJDK.java) | | [Explaination for approch #3](https://leetcode.com/problems/complement-of-base-10-integer/discuss/613118/4-approaches%3A-bitwise-operation-math-formular-one-naive-simulation-and-bonus)
...
1232 | [Check If It Is a Straight Line](https://leetcode.com/problems/check-if-it-is-a-straight-line/) | [Java - Slope](solutions/check_if_it_is_a_straight_line.java)
1290 | [Convert Binary Number in a Linked List to Integer](https://leetcode.com/problems/convert-binary-number-in-a-linked-list-to-integer/) | [Java](solutions/convert_binary_number_in_a_linked_list_to_integer.java) | [GeeksForGeeks](https://www.geeksforgeeks.org/decimal-equivalent-of-binary-linked-list/)
1295 | [Find Numbers with Even Number of Digits](https://leetcode.com/problems/find-numbers-with-even-number-of-digits/) | 1. [Java - String](solutions/find_numbers_with_even_number_of_digits.java), <br> 2. [Java - Math](solutions/find_numbers_with_even_number_of_digits_math.java), <br> 3.[Java - Functional](solutions/find_numbers_with_even_number_of_digits_functional.java) | 
1305 | [All Elements in Two Binary Search Trees](https://leetcode.com/problems/all-elements-in-two-binary-search-trees/) | :lock: <br> 1. [Java - Recursive](solutions/all_elements_in_two_binary_search_trees_recursive.java), <br> 2. [Java - Iterative](solutions/all_elements_in_two_binary_search_trees_iterative.java)
1342 | [Number of Steps to Reduce a Number to Zero](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/) | :lock: <br> 1. [Java - Brute](solutions/no_of_steps_to_reduce_a_number_to_zero_brute.java), <br> 2. [Java - Counting Bits](solutions/no_of_steps_to_reduce_a_number_to_zero_counting_bits.java), <br> 3. [Java - Counting Bits with Bitwise Operators](solutions/no_of_steps_to_reduce_a_number_to_zero_counting_bits_with_bitwise.java)

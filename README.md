...
287 | [Find the Duplicate Number](https://leetcode.com/problems/find-the-duplicate-number/) | 1. [Java - Sorting](solutions/find_the_duplicate_number_sorting.java), <br> 2. [Java - HashSet](solutions/find_the_duplicate_number_hashset.java), <br> 3. [Java - Floyd Cycle Detection]() | |
340 | :lock: [Longest Substring with At Most K Distinct Characters](https://leetcode.com/problems/longest-substring-with-at-most-k-distinct-characters/) | [Java - Sliding Window](solutions/longest_substring_with_at_most_k_distinct_characters.java) 
